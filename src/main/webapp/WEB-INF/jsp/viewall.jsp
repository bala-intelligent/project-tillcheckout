...
<c:forEach items="${foodproductsList}" var="foodproducts">
    ...
    <div class="productprice">Rs.<c:out value="${foodproducts.productprice}"></c:out></div>
    <div class="pull-right">
    <a href="#" class="btn btn-danger btn-xs" role="button">BUY</a></div>
	
  <sec:authorize access="hasRole('ROLE_ADMIN')">
        <div class="pull-right"> 
        <a href="<c:url value="edit/${foodproducts.productId}"/>" class="btn btn-success btn-xs" role="button">
        Edit
          <span class="glyphicon glyphicon-edit"></span> 
        </a>
        </div>
        <div class="pull-left"><a href="<c:url value="delete/${foodproducts.productId}"/>" class="btn btn-success btn-xs" role="button">
        Delete
        <span class="glyphicon glyphicon-trash"></span>
        </a></div>
  </sec:authorize>
        <div class="pull-right"> <a href="<c:url value="view/${foodproducts.productId }"/>" class="btn btn-danger btn-xs" role="button">
        view
